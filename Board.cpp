#include "Board.h"
#include "App.h"
//Chức năng chính: Quản lý logic của bảng game.

//Liên kết:

//Sử dụng đối tượng Candy để kiểm tra và xử lý các trình tự kẹo.

//Sử dụng MusicPlayer để phát các hiệu ứng âm thanh khi có trình tự kẹo được xóa.
Animation animation;
